...
class GOSIASimFitter {
  ...
  void  AddBeamRelativeMatrixElement(std::string,int,int,int,int,int,int,double,double,double,bool=false);		/*!< Add a fitting matrix element for the beam */
  ...
  void  AddTargetRelativeMatrixElement(std::string,int,int,int,int,int,int,double,double,double,bool=false);		/*!< Add a fitting matrix element for the beam */
